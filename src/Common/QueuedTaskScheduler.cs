...
/// <summary>
    ...
    public sealed class QueuedTaskScheduler : TaskScheduler, IDisposable
    {
            ...
            int maxConcurrencyLevel)
        {
            ...
            _concurrencyLevel = maxConcurrencyLevel != 0 ? maxConcurrencyLevel : System.Environment.ProcessorCount;
            ...
            Action threadFinally = null)
        {
            ...
            else if (threadCount == 0) _concurrencyLevel = System.Environment.ProcessorCount;
            ...
            {
                _threads[i] = new System.Threading.Thread(() => ThreadBasedDispatchLoop(threadInit, threadFinally), threadMaxStackSize)
                {
                ...
                try
                {
                    ...
                    while (true)
                    {
                        ...
                        catch (ThreadAbortException)
                        {
                            ...
                            if (!System.Environment.HasShutdownStarted && !AppDomain.CurrentDomain.IsFinalizingForUnload())
                            {
